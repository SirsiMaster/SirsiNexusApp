...
1.  `SIRSI_RULES.md` (this file — canonical; auto-synced to `GEMINI.md` and `CLAUDE.md`)
...
*   **User**: "I want X."
*   **Agent Response**: "I see you want X. However, analyzing `ADR-002`, Y might be better because [Reason]. Should we do Y? If you insist on X, here is the risk."
...
---
**Canonical source**: `SIRSI_RULES.md`  
**Auto-synced to**: `GEMINI.md`, `CLAUDE.md` (via pre-commit hook)

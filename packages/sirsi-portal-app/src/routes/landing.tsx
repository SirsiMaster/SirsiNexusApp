...
function LandingPage() {
    return (
        <>
            ...
            <section id="SirsiNexusPortal-platform" className="relative py-20 bg-gradient-to-tr from-slate-50 via-white to-emerald-50/40 dark:from-slate-800 dark:via-slate-900 dark:to-emerald-950/60 overflow-hidden">
                {/* Organic Pattern */}

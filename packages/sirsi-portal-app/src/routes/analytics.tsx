/**
 * Analytics Dashboard — Tabbed: Overview + Deep Dive
 * Merges analytics.html + analytics-advanced.html into a single route.
 *
 * Tab 1 "Overview": KPI cards, User Growth, Activity Distribution, Engagement
 * Tab 2 "Deep Dive": Heatmap, Treemap, Journey Flow, Radar, Stream, Geo
 *
 * Typography: Inter (body ≤ 500, Rule 21), Cinzel (headings)
 */

        ...
        <div style={{ maxWidth: '100%', margin: '0 auto', padding: '0 4rem' }}>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <span style={{ color: '#022c22', fontSize: '14px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.15em' }}>
                ...
                <div style={{
                    ...
                    <div><strong style={{ color: '#022c22' }}>Document:</strong> MSA-{currentYear}-111-{tpl.docCode}</div>
                    <div><strong style={{ color: '#022c22' }}>Effective Date:</strong> {currentDate}</div>
                    <div><strong style={{ color: '#022c22' }}>Status:</strong> BINDING ENFORCEABLE</div>
                </div>
            </div>
            ...
            <div className="legal-viewer" style={{
                ...
                padding: '60px',
                borderRadius: '4px',
                boxShadow: '0 40px 100px -20px rgba(2, 44, 34, 0.1)',
                border: '1px solid rgba(2, 44, 34, 0.1)'
            }}>
                {/* Full MSA Content */}
                {/* Full MSA Content - VERBATIM REPRODUCTION PER RULE 9 */}
                <div style={{ color: '#022c22', lineHeight: '1.8', fontSize: '17px', textAlign: 'justify' }}>

                    <section style={{ marginBottom: '48px' }}>
                        <h2 style={{ marginTop: 0, color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '28px', textAlign: 'center', letterSpacing: '0.1em' }}>MASTER SERVICES AGREEMENT (MSA)</h2>
                        ...
                        <div style={{ margin: '40px 0', borderTop: '1px solid rgba(2, 44, 34, 0.1)' }}></div>

                        <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px' }}>1. RECITALS</h3>
                    ...
                    <section style={{ marginBottom: '48px' }}>
                        <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px' }}>2. DEFINITIONS</h3>
                    ...
                    <section style={{ marginBottom: '48px' }}>
                        <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px' }}>3. SERVICES AND ENGAGEMENT</h3>
                    ...
                    <section style={{ marginBottom: '48px' }}>
                        <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px' }}>4. COMPENSATION AND PAYMENT</h3>
                    ...
                    <section style={{ marginBottom: '48px' }}>
                        <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px' }}>5. INTELLECTUAL PROPERTY RIGHTS</h3>
                    ...
                    <section style={{ marginBottom: '48px' }}>
                        <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px' }}>6. CONFIDENTIALITY</h3>
                    ...
                    <section style={{ marginBottom: '48px' }}>
                        <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px' }}>7. WARRANTIES AND COVENANTS</h3>
                    ...
                    <section style={{ marginBottom: '48px' }}>
                        <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px' }}>8. INDEMNIFICATION</h3>
                    ...
                    <section style={{ marginBottom: '48px' }}>
                        <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px' }}>9. LIMITATION OF LIABILITY</h3>
                    ...
                    <section style={{ marginBottom: '48px' }}>
                        <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px' }}>10. TERM AND TERMINATION</h3>
                    ...
                    <section style={{ marginBottom: '48px' }}>
                        <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px' }}>11. GENERAL PROVISIONS</h3>
                ...
                {/* Appendix A Header */}
                <div style={{ margin: '80px 0 40px 0', borderTop: '2px solid #A68936', paddingTop: '40px' }}>
                    <h2 style={{ color: '#A68936', textAlign: 'center', fontFamily: "'Cinzel', serif", fontSize: '24px' }}>EXHIBIT A: STATEMENT OF WORK (SOW)</h2>
                    <h4 style={{ textAlign: 'center', color: '#64748b', marginTop: '8px', marginBottom: '40px' }}>Full Execution Details and Technical Specifications</h4>
                </div>

                <div style={{ color: '#022c22', lineHeight: '1.8', fontSize: '17px' }}>
                    <p style={{ textAlign: 'center', color: '#94a3b8', fontStyle: 'italic', marginBottom: '40px' }}>
                        Project Name: {projectName} Platform Development • SOW Reference: SOW-{currentYear}-001 • Date: {currentDate}
                    </p>

                    <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px', borderBottom: '1px solid rgba(2, 44, 34, 0.1)', paddingBottom: '10px' }}>1. EXECUTIVE OVERVIEW</h3>
                    <p>{tpl.msaSowOverview}</p>
                    <p><strong>Objective:</strong> {tpl.msaSowObjective}</p>

                    <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px', marginTop: '40px', borderBottom: '1px solid rgba(2, 44, 34, 0.1)', paddingBottom: '10px' }}>2. DETAILED SCOPE OF SERVICES</h3>

                    <h4 style={{ color: '#022c22', fontSize: '16px', marginBottom: '10px' }}>2.1 Core Vault & Data Architecture</h4>
                    ...
                    <h4 style={{ color: '#022c22', fontSize: '16px', marginBottom: '10px' }}>2.2 Selected Service Modules</h4>
                    <div style={{ background: '#f8faf9', padding: '20px', border: '1px solid #e2e8f0', borderRadius: '8px', marginBottom: '24px' }}>
                    ...
                    <h4 style={{ color: '#022c22', fontSize: '16px', marginBottom: '10px' }}>2.3 Technology Stack (SirsiNexus V4)</h4>
                    <ul style={{ paddingLeft: '20px', marginBottom: '20px' }}>
                    ...
                    <h4 style={{ color: '#022c22', fontSize: '16px', marginBottom: '10px' }}>2.4 Document Inventory & Scope</h4>
                    ...
                    <h4 style={{ color: '#022c22', fontSize: '16px', marginBottom: '10px' }}>2.5 System Integrations</h4>
                    <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '24px', fontSize: '16px' }}>
                        <thead>
                            <tr style={{ borderBottom: '1px solid rgba(2, 44, 34, 0.1)' }}>
                    ...
                    <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px', marginTop: '40px', borderBottom: '1px solid rgba(2, 44, 34, 0.1)', paddingBottom: '10px' }}>3. WORK BREAKDOWN STRUCTURE (WBS)</h3>
                    <div style={{ display: 'grid', gap: '24px' }}>
                        {aggregatedPhases.length > 0 ? aggregatedPhases.map((phase, idx) => (
                            <div key={idx}>
                                <h4 style={{ color: '#022c22', marginBottom: '8px', textTransform: 'uppercase' }}>
                                    PHASE {phase.phaseNum}: {phase.name} (Weeks {phase.weeks})
                                </h4>
                                <ul style={{ fontSize: '16px', color: '#64748b' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '20px', marginTop: '32px' }}>
                        <div style={{ background: '#f8faf9', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
                            <div style={{ color: '#94a3b8', fontSize: '12px', textTransform: 'uppercase', marginBottom: '5px' }}>Total Timeline</div>
                            <div style={{ color: '#022c22', fontSize: '20px', fontWeight: 600 }}>{totalTimeline} Weeks</div>
                        </div>
                        <div style={{ background: '#f8faf9', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
                            <div style={{ color: '#94a3b8', fontSize: '12px', textTransform: 'uppercase', marginBottom: '5px' }}>Engineering Load</div>
                            <div style={{ color: '#022c22', fontSize: '20px', fontWeight: 600 }}>{totalHours} Hours</div>
                        </div>
                        <div style={{ background: 'rgba(166,137,54,0.05)', padding: '16px', borderRadius: '8px', textAlign: 'center', border: '1px solid rgba(166,137,54,0.2)' }}>
                            <div style={{ color: '#A68936', fontSize: '12px', textTransform: 'uppercase', marginBottom: '5px' }}>Total Investment</div>
                            <div style={{ color: '#A68936', fontSize: '20px', fontWeight: 700 }}>${totalAmount.toLocaleString()}</div>
                        </div>
                    </div>

                    <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px', marginTop: '40px', borderBottom: '1px solid rgba(2, 44, 34, 0.1)', paddingBottom: '10px' }}>4. ASSUMPTIONS</h3>
                    <ol style={{ paddingLeft: '20px', fontSize: '16px', color: '#64748b' }}>
                ...
                <div style={{ margin: '80px 0 40px 0', borderTop: '2px solid #A68936', paddingTop: '40px' }}>
                    <h2 style={{ color: '#A68936', textAlign: 'center', fontFamily: "'Cinzel', serif", fontSize: '24px' }}>EXHIBIT B: COST & VALUATION ANALYSIS</h2>
                </div>
                <div style={{ color: '#022c22', lineHeight: '1.8', fontSize: '17px' }}>
                    <h3 style={{ color: '#A68936', fontFamily: "'Cinzel', serif", fontSize: '20px', marginBottom: '20px', borderBottom: '1px solid rgba(2, 44, 34, 0.1)', paddingBottom: '10px' }}>1. DISCOUNT & VALUATION REALIZATION</h3>
                    <p>{tpl.msaCostIntro}</p>

                    <div style={{ background: '#f8faf9', padding: '24px', borderRadius: '12px', border: '1px solid rgba(166, 137, 54, 0.2)' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
                            <span>Gross Development Value (Market Valuation)</span>
                            <span style={{ color: '#022c22' }}>${marketValue.toLocaleString()}</span>
                        </div>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px', color: '#A68936' }}>
                            <span>SirsiNexus Efficiency Discount (Discount Realization)</span>
                            <span>-${familyDiscount.toLocaleString()}</span>
                        </div>
                        <div style={{ borderTop: '1px solid rgba(2, 44, 34, 0.1)', marginTop: '12px', paddingTop: '12px', display: 'flex', justifyContent: 'space-between', fontSize: '18px', fontWeight: 'bold' }}>
                            <span style={{ color: '#A68936' }}>TOTAL PROJECT INVESTMENT</span>
                            <span style={{ color: '#022c22' }}>${totalAmount.toLocaleString()}</span>
                        </div>
                    </div>
                    <p style={{ fontSize: '15px', color: '#475569', marginTop: '16px', fontStyle: 'italic' }}>* Valuations based on standard $250/hr agency blended rates. SirsiNexus efficiency discount reflects component library reuse and accelerated delivery methodology.</p>
                </div>
            ...
            <div style={{
                maxWidth: '1200px',
                margin: '48px auto',
                background: 'rgba(166, 137, 54, 0.05)',
                border: '1px solid rgba(166, 137, 54, 0.2)',
                borderRadius: '12px',
                padding: '32px'
            }}>
                <h3 style={{
                ...
                <label style={{
                    ...
                    <span>
                        ...
                        Statement of Work, constitutes a binding legal contract for a total investment of <strong style={{ color: '#A68936' }}>${totalAmount.toLocaleString()}</strong>.
                    </span>
                </label>
            </div>
